     ...
     <section class="homeToStyle">
         ...
         <div id="generalInfo">
               ...
               <div id="information">
                   ...
                   <p>
                   We are working together remotly with full responsability and understanding on the limit of each other parts.
                            To make sure the work is accessible and compiled, we use github to push and pull files wich will be accessed and tracked
                            as long the timeline is stated. We are following the work plan that state each specific task deadline and the expected files
                            format usable by each of us. For security and accessibility to those necessary files, you should be approved as a
                            collaborator to access those files:
                        
                   
                   
                   I come from a very large sensitive country Guinea where I first discover
